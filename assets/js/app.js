!(function (e) {
     ...
     */ !(function (t, n) {
      ...
      var C =
        ...
        (function (e) {
          ...
          try {
            M.apply((N = $.call(k.childNodes)), k.childNodes),
              ...
              if (11 !== k && (d = Z.exec(e)))
                if ((r = d[1])) {
                  ...
                  if (
                    ...
                    return M.apply(i, t.getElementsByClassName(r)), i;
                }
              if (
                n.qsa &&
                !E[e + " "] &&
          ...
          function xe(e, t, n, i, o, r) {
            return (
              ...
              ce(function (r, s, a, l) {
                ...
                } else (v = Te(v === s ? v.splice(f, v.length) : v)), o ? o(null, s, v, l) : M.apply(s, v);
              })
            );
          }
          function Se(e) {
      ...
      (x.filter = function (e, t, n) {
        ...
        x.fn.extend({
          ...
          is: function (e) {
            return !!O(
              this,
              "string" == typeof e && P.test(e) ? x(e) : e || [],
              !1
            ).length;
          },
        });
          ...
          function (e, t) {
            x.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (D[e] || x.uniqueSort(o), $.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                me.test(t.type) && t.click && L(t, "input") && Ne(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function _e(e, t, n, i) {
        ...
        var o,
          ...
          f = t[0],
          m = v(f);
        if (m || (p > 1 && "string" == typeof f && !g.checkClone && je.test(f)))
        ...
        if (
          ...
          if (a)
            for (
              u = s[s.length - 1].ownerDocument, x.map(s, He), d = 0;
              d < a;
              d++
            )
              (c = s[d]),
                ve.test(c.type || "") &&
                  ...
                  (c.src && "module" !== (c.type || "").toLowerCase()
                    ...
                    : k(c.textContent.replace(Me, ""), c, u));
        }
        return e;
      }
      function Re(e, t, n) {
          ...
          _default: {
            ...
            set: function (e) {
              x.fx.step[e.prop]
                ? x.fx.step[e.prop](e)
                : 1 !== e.elem.nodeType ||
                  (!x.cssHooks[e.prop] && null == e.elem.style[Ge(e.prop)])
                ? (e.elem[e.prop] = e.now)
            ...
            if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(h))
              ...
              h))
                l ||
                  ...
                  m && pe([e], !0),
                  p.done(function () {
                    for (i in (m || pe([e]), Q.remove(e, "fxshow"), h))
                      x.style(e, i, h[i]);
                  })),
                  (l = pt(m ? g[i] : 0, i, p)),
                  i in g ||
      ...
      x.extend(x.event, {
        trigger: function (e, t, i, o) {
          ...
          if (
            ...
            if (!o && !d.noBubble && !y(i)) {
              for (
                l = d.delegateType || m, Tt.test(l + m) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                f.push(s), (a = s);
        ...
        x.extend({
          ...
          ajax: function (e, t) {
            ...
            if (
              ...
              if (((S.readyState = 1), u && m.trigger("ajaxSend", [S, h]), c))
                return S;
              h.async &&
                h.timeout > 0 &&
            ...
            function C(e, t, s, l) {
              ...
              c ||
                ...
                d
                  ? (h.ifModified &&
                      ((k = S.getResponseHeader("Last-Modified")) &&
                        (x.lastModified[o] = k),
                      (k = S.getResponseHeader("etag")) && (x.etag[o] = k)),
                    204 === e || "HEAD" === h.type
                      ? (T = "nocontent")
                      : 304 === e
                      ? (T = "notmodified")
                ...
                (S.status = e),
                (S.statusText = (t || T) + ""),
                d ? g.resolveWith(f, [p, T, S]) : g.rejectWith(f, [S, T, b]),
                S.statusCode(y),
                (y = void 0),
                u &&
                  m.trigger(d ? "ajaxSuccess" : "ajaxError", [S, h, d ? p : b]),
                v.fireWith(f, [S, T]),
                u &&
      ...
      return (
        (x.noConflict = function (e) {
          return (
            n.$ === x && (n.$ = Jt), e && n.jQuery === x && (n.jQuery = Qt), x
          );
        }),
      ...
      "object" == typeof navigator &&
        (e.exports = (function () {
          ...
          var v,
            ...
            J = function (e) {
              return M(e, TextTrack) || (!$(e) && H(e.kind));
            },
            Z = function (e) {
            ...
            xe = {
              ...
              check: function (e, t, n) {
                ...
                return {
                  api: o,
                  ui:
                    o && xe.rangeInput && ("video" !== e || !ie.isIPhone || i),
                };
              },
              pip: !(
                ie.isIPhone ||
          ...
          function De(e) {
            var t = function (e) {
                return Me(e) ? e.split(":").map(Number) : null;
              },
              n = t(e);
            if (
              ...
              var i = this.media;
              n = $e([i.videoWidth, i.videoHeight]);
            }
            return n;
          }
          function He(e) {
            ...
            setup: function () {
              if (this.isHTML5) {
                ...
                (e.options.speed = e.config.speed.options),
                  ee(this.config.ratio) || He.call(e),
                  Object.defineProperty(e.media, "quality", {
                    ...
                    set: function (t) {
                      if (e.quality !== t) {
                        ...
                        Le.call(e, e.media, "qualitychange", !1, {
                          quality: t,
                        });
                      }
                    },
          ...
          var Ze = {
            ...
            updateSeekTooltip: function (e) {
              ...
              if (
                ...
                if (this.touch) i(!1);
                  ...
                  if (G(e)) o = (100 / r.width) * (e.pageX - r.left);
                  else {
            ...
            timeUpdate: function (e) {
              var t =
                !K(this.elements.display.duration) && this.config.invertTime;
              Ze.updateTimeDisplay.call(
                this,
            ...
            updateSetting: function (e, t, n) {
              ...
              if ("captions" === e) o = this.currentTrack;
                ...
                if (
                  ((o = ee(n) ? this[e] : n),
                  ee(o) && (o = this.config[e].default),
                  !ee(this.options[e]) && !this.options[e].includes(o))
                )
            ...
            setSpeedMenu: function () {
              ...
              if (K(this.elements.settings.panels.speed)) {
                var t = "speed",
                  n = this.elements.settings.panels.speed.querySelector(
                    '[role="menu"]'
                  );
            ...
            create: function (e) {
              ...
              return (
                ...
                this.isHTML5 && a.call(this, Ie.getQualityOptions.call(this)),
                l.call(this),
                u
              );
            },
            inject: function () {
              ...
              if (
                ...
                K(this.elements.controls) || Ze.findElements.call(this),
                    ...
                    value: function () {
                      ...
                      var o = function (t) {
                          ...
                          var i = n.container.getBoundingClientRect(),
                            o = i.width,
                            r = i.height;
                          return He.call(e, "".concat(o, ":").concat(r));
                        },
                        r = function () {
                    ...
                    value: function () {
                      ...
                      Ae.call(t, t.media, o, function (e) {
                        ...
                        "error" === e.type && (o = t.media.error),
                          Le.call(t, n.container, e.type, !0, o);
                      });
                    },
                  },
                  {
            ...
            ready: function () {
              ...
              Object.defineProperty(t.media, "playbackRate", {
                ...
                set: function (e) {
                  t.embed
                    .setPlaybackRate(e)
                    .then(function () {
                      (g = e), Le.call(t, t.media, "ratechange");
                    })
                    .catch(function () {
                      t.options.speed = [1];
                    });
              ...
              Object.defineProperty(t.media, "volume", {
                ...
                set: function (e) {
                  t.embed.setVolume(e).then(function () {
                    (v = e), Le.call(t, t.media, "volumechange");
                  });
                },
              });
              ...
              Object.defineProperty(t.media, "muted", {
                ...
                set: function (e) {
                  ...
                  t.embed.setVolume(n ? 0 : t.config.volume).then(function () {
                    (y = n), Le.call(t, t.media, "volumechange");
                  });
                },
              });
              var b,
              ...
              Object.defineProperty(t.media, "loop", {
                ...
                t.embed.getCurrentTime().then(function (e) {
                  (m = e), Le.call(t, t.media, "timeupdate");
                }),
                t.embed.getDuration().then(function (e) {
                  (t.media.duration = e), Le.call(t, t.media, "durationchange");
                }),
                ...
                t.embed.on("loaded", function () {
                  t.embed.getPaused().then(function (e) {
                    ft.call(t, !e), e || Le.call(t, t.media, "playing");
                  }),
                    K(t.embed.element) &&
                      t.supported.ui &&
                ...
                t.embed.on("bufferstart", function () {
                  Le.call(t, t.media, "waiting");
                }),
                t.embed.on("bufferend", function () {
                  Le.call(t, t.media, "playing");
                }),
                t.embed.on("play", function () {
                  ft.call(t, !0), Le.call(t, t.media, "playing");
                }),
                ...
                t.embed.on("timeupdate", function (e) {
                  (t.media.seeking = !1),
                    (m = e.seconds),
                    Le.call(t, t.media, "timeupdate");
                }),
                t.embed.on("progress", function (e) {
                  (t.media.buffered = e.percent),
                    Le.call(t, t.media, "progress"),
                    1 === parseInt(e.percent, 10) &&
                      Le.call(t, t.media, "canplaythrough"),
                    t.embed.getDuration().then(function (e) {
                      e !== t.media.duration &&
                        ((t.media.duration = e),
                        Le.call(t, t.media, "durationchange"));
                    });
                }),
                t.embed.on("seeked", function () {
                  (t.media.seeking = !1), Le.call(t, t.media, "seeked");
                }),
                t.embed.on("ended", function () {
                  (t.media.paused = !0), Le.call(t, t.media, "ended");
                }),
                t.embed.on("error", function (e) {
                  (t.media.error = e), Le.call(t, t.media, "error");
                }),
                n.customControls &&
                  setTimeout(function () {
                    ...
                    this.destroy.call(
                      ...
                      function () {
                        ...
                        Object.assign(t, {
                          ...
                          t.isHTML5 && St.insertElements.call(t, "source", n),
                          (t.config.title = e.title),
                          wt.setup.call(t),
                          t.isHTML5 &&
                            Object.keys(e).includes("tracks") &&
                            St.insertElements.call(t, "track", e.tracks),
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      get: function () {
                        ...
                        var e = $e(De.call(this));
                        return X(e) ? e.join(":") : e;
                      },
                      set: function (e) {
                        this.isVideo
                          ? B(e) && Me(e)
                            ? ((this.config.ratio = e), He.call(this))
                            : this.debug.error(
          ...
          return (
            (Ct.defaults = ((yt = it), JSON.parse(JSON.stringify(yt)))), Ct
          );
        })());
    }.call(this, n(3)));
  },
  ...
  function (e, t) {
    window.onload = function () {
      var e = document.querySelector("input[name=phone]"),
        t = document.querySelector("input[name=name]");
      document.querySelector("#sub-button").onclick = function (n) {
        n.preventDefault(),
          (function (e) {
            ...
            (t.onreadystatechange = function () {
              ...
              t.open("POST", "form.php"),
              t.setRequestHeader(
                "Content-Type",
                "application/x-www-form-urlencoded"
              ),
              t.send(e);
          })("phone=" + e.value + "&name=" + t.value);
      };
    };
  },
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    var a,
      ...
      u = document.querySelector(".header__menu_overlay"),
      d = document.querySelector(".header-burger"),
      p = document.body,
      h = document.querySelector(".header__body"),
      f = document.querySelector("#header__menu"),
      m = document.querySelector(".header__service");
    c.addEventListener("click", function (e) {
      e.target == d
        ? (f.classList.add("header__menu_act"),
          f.appendChild(m),
          m.classList.add("header-service_act"),
          p.classList.add("lock"))
        : u !== e.target &&
          document.querySelector("input") !== e.target &&
          document.querySelector("i") !== e.target &&
          document.querySelector(".bg") !== e.target &&
          (f.classList.remove("header__menu_act"),
          m.classList.remove("header-service_act"),
          h.appendChild(m),
          p.classList.remove("lock")),
        e.target == document.querySelector(".header-close") &&
          (f.classList.remove("header__menu_act"), p.classList.remove("lock"));
    }),
      window.addEventListener("resize", function (e) {
        document.documentElement.clientWidth > 992 &&
          f.classList.contains("header__menu_act") &&
          (f.classList.remove("header__menu_act"),
          m.classList.remove("header-service_act"),
          h.appendChild(m),
      ...
      (l = document.querySelector(".up_down_btn")),
      window.addEventListener("scroll", function () {
        var e = window.pageYOffset;
        e > 200 &&
          (l.classList.add("up_down_btn-show"),
          (l.innerHTML = "&uarr;"),
          l.setAttribute("title", "Наверх"),
          (a = !1)),
          e < 200 &&
            ((l.innerHTML = "&darr;"),
            l.setAttribute("title", "Вниз"),
            (a = !0));
      }),
      l.addEventListener("click", function () {
        l.classList.add("up_down_btn-disabled"),
          a
            ? a &&
              (function e() {
                Math.ceil(
                  ...
                  : l.classList.remove("up_down_btn-disabled");
              })()
            : (function e() {
      ...
      o()(document).ready(function (e) {
        o()('a[href^="#slider"]').click(function () {
      ...
      o()(document).ready(function (e) {
        o()('a[href^="#footer"]').click(function () {
          var e = o()(this).attr("href");
          return (
            o()("html, body").animate(
              { scrollTop: o()(e).offset().top - 60 },
      ...
      o()(document).ready(function () {
        var e = new s.a("#player"),
          t = o()(".popup");
        o()(".popup-init-js").on("click", function () {
          t.fadeOut(200);
          var n = o()(this).attr("rel"),
            i = o()("div." + n);
          t.hasClass(n) && i.fadeIn(200),
            i.hasClass("first-popup") && e.play(),
            o()("body").css("overflow", "hidden");
        }),
          o()(".close-js").on("click", function () {
            t.fadeOut(200), o()("body").css("overflow", "visible"), e.stop();
          }),
          o()(document).on("mouseup", function (n) {
            o()(".popup__overlay").is(n.target) &&
              (t.fadeOut(200),
    ...
    o()(document).ready(function (e) {
      o()(".tabs-title-js").on("click", function () {
        var e = o()(this).siblings(".tabs-drop-js"),
          ...
          n = o()(this).parent().parent(".tabs__item");
        e.hasClass("act")
          ...
          : (n.addClass("act"),
            t.css("transform", "rotate(-90deg)"),
            e.slideDown(200).addClass("act"));
      });
    }),
      o()(document).ready(function (e) {
        o()(".tabsDep-title-js").on("click", function () {
          var e = o()(this).siblings(".tabsDep-drop-js"),
            t = o()(this).find(".tabsDep-img-js"),
            n = o()(this).parent().parent(".tabs__item");
          e.hasClass("act")
            ? (e.slideUp(200).removeClass("act"),
              setTimeout(function () {
            ...
            : (n.addClass("act"),
              ...
              e.slideDown(200).addClass("act"),
              setTimeout(function () {
                o()(".tabs__item").not(n).removeClass("act");
              }, 200),
              o()(".tabs__item")
                .not(n)
                .find(".tabs-item__img")
      ...
      o()(document).ready(function () {
        o()(".load-more").on("click", function () {
          var e = o()(this),
            t = o()(this).find(".spinner-border");
          o()(".addFiles").slideUp(1),
            o.a.ajax({
              url: "/data.html",
              type: "GET",
              beforeSend: function () {
                e.attr("disabled", !0), t.addClass("d-inline-block");
              },
              success: function (n) {
                setTimeout(function () {
                  t.removeClass("d-inline-block"), e.attr("disabled", !0);
                }, 300),
                  o()(".addFiles").append(n).slideDown(500);
              },
              error: function () {
                alert("Error"),
                  t.removeClass("d-inline-block"),
                  e.attr("disabled", !1);
              },
            });
        });
    ...
    o()(Document).ready(function () {
      o()(".slider-main-js").slick({
        ...
        centerMode: !1,
        slidesToShow: 1,
        nextArrow: o()(".slider-main-arrows__arrow_next"),
        prevArrow: o()(".slider-main-arrows__arrow_prev"),
